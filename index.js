...
async function init() {
    const response = await inquirer.prompt(
        [{
            ...
            choices: ["hi", "view all department", "view all job titles", "view all employees", "add department", "add all employees", "update employee role"],
            name: "menu",
    ...
    if (response.menu === "view all department") {
      ...
      async function updateemployees() {
        ...
        const employees = await db.promise().query(`update employees set job_id = ? where employee_id = ? `,[response.role,response.employee])
        init()
      }
